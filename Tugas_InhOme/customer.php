 ...
 <html lang="en" dir="ltr">
   ...
   <body>
     ...
     if (isset($_POST["search"])) {
       // code...
       $search = $_POST["search"];
       $sql = "select * from customer where id_customer like '%$search' or
       nama like '%$search' or alamat like '%$search' or kontak like '%$search' or
       username like '%$search' or password like '%$search'";
     }else{
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="tokobuku.php" style="color: white;">Buku</a>
                        </li>
                        <li class="nav-item">
